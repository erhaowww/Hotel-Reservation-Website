<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addUserToRole.aspx.cs" MasterPageFile="~/AdminPage/MasterPage/Nav.Master" Inherits="PeaceHotel.AdminPage.addUserToRole" %>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
                    <div class="page-header">
                        ...
                        <asp:Label ID="lblCount" style=" margin-top: 33px; position: absolute;" runat="server" />
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <asp:Button Text="Add User to Role" id="AddUserButton"
                                                runat="server" OnClick="AddUser_OnClick" />
                                        </td>
                                    </tr>
                                </table>
                            </form>
