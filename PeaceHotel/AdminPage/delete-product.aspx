                            ...
                            <div class="modal-content"style="top:180px;">
                                <form id="form1" runat="server">
                                    ...
                                    <div class="modal-body text-center"> <img src="../assets/img/sent.png" alt="" width="50" height="46">
                                        <h3 class="delete_class">Are you sure want to delete this Room<br>(RoomID = <%=rId.ToString() %> RoomNumber = "<%= rNum.ToString() %>")?</h3>
                                        <div class="m-t-20"> <a href="all-room.aspx" class="btn btn-white" data-dismiss="modal">Close</a>
