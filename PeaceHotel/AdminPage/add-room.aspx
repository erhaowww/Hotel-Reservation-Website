<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-room.aspx.cs" MasterPageFile="~/AdminPage/MasterPage/Nav.Master" Inherits="PeaceHotel.AdminPage.add_product" %>
            ...
            <div class="content container-fluid">
                ...
                <form runat="server" enctype="multipart/form-data" id="Form1">
                    <div class="row">
                            ...
                            <div class="row formtype">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="roomType" runat="server" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="roomType" DataValueField="roomTypeId">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="roomName" CssClass="form-control" runat="server" Text=''></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Room No </label><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="roomNo" Display="Dynamic" ErrorMessage="Required input room number." CssClass="error">*</asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="images" id="divimages1">
                                            <div class="pic" id="pic1" onclick="triggerClick1()">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Image 1 need to upload" ControlToValidate="image1" CssClass="error" Display="Dynamic">*</asp:RequiredFieldValidator>
                                            </div> 
                                        </div>
                                        <div class="images" id="divimages2">
                                            <div class="pic" id="pic2" onclick="triggerClick2()">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Image 2 need to upload" ControlToValidate="image2" CssClass="error" Display="Dynamic">*</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="images" id="divimages3">
                                            <div class="pic" id="pic3" onclick="triggerClick3()">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Image 3 need to upload" ControlToValidate="image3" CssClass="error" Display="Dynamic">*</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6" style="display:none" id="displayControl2">
                                    <div class="form-group">
                                        <label>Description 2</label>
                                        <asp:TextBox ID="description2" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6" style="display:none" id="displayControl3">
                                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <asp:Button ID="submitBtn" runat="server" Text="Add Room" CssClass="btn btn-primary buttonedit" OnClick="submitBtn_Click" />
                        </div>
