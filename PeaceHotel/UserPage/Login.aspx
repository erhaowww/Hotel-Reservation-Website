<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserPage/MasterPage/Nav.Master" CodeBehind="Login.aspx.cs" Inherits="PeaceHotel.UserPage.Login" %>
 ...
 <%--           <asp:Login ID="Login2" runat="server" OnLoggedIn="Login1_LoggedIn" OnLoggingIn="Login1_LoggingIn" >
          ...
          <br />
       <asp:Button ID="Button3" runat="server" ForeColor="Black" Height="25px" Text="Register" Width="283px" PostBackUrl="~/UserPage/Register.aspx" DestinationPageUrl="~/UserPage/Home.aspx"/>
